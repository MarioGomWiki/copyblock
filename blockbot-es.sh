...
python copyblock.py --comment-pattern '(?i)^{{blocked p2p proxy' --block-reason "{{Proxy P2P bloqueado}}. Visita [[Wikipedia:Proxies abiertos|la página informativa]] si estás afectado. <!-- Proxy P2P confirmado por API -->" --really-run
